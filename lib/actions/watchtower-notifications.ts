...
function formatWhatsAppAlert(
  ...
  return `This is an automated system notification generated by automize. An alert has been triggered due to a system condition that requires attention. Alert severity level: ${severity}. Alert summary: ${rule.name}. Client name:${clientName}. Current system value:${currentValue}. Expected or target value: ${expectedValue}. This message is sent automatically and does not require a reply.`
}
