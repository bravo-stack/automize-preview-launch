...
function formatWhatsAppAlert(
  ...
  return `
    This is an automated system notification generated by automize.

    An alert has been triggered due to a system condition that requires attention.
    ...
    This message is sent automatically and does not require a reply.
  `
}
