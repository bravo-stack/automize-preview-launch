...
// Export icons for use in layout.tsx (for pod user)
export { icons }

// Exec user navigation - sectioned
export const exec: NavSection[] = [
  {
    label: 'Overview',
    items: [
      { text: 'Home', url: '', svg: icons.home },
      { text: 'Calendar', url: 'calendar', svg: icons.calendar },
    ],
  },
  {
  ...
  },
  {
    label: 'Communication',
    items: [
      { text: 'IXM-Bot', url: 'ixm-bot', svg: icons.ixmBot },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Manage Pods', url: 'manage-pods', svg: icons.managePods },
      { text: 'Onboarding', url: 'onboarding', svg: icons.onboarding },
      { text: 'Client Forms', url: 'forms', svg: icons.clientForms },
      { text: 'Services', url: 'services', svg: icons.services },
    ],
  },
  {
    text: 'Archive',
...
// Onboarder user navigation - sectioned
export const onboarder: NavSection[] = [
  {
    label: 'Overview',
    items: [{ text: 'Home', url: '', svg: icons.home }],
  },
  {
    label: 'Management',
    items: [
